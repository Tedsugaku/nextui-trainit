...
export default function SectionHome(){
    ...
    const infoSection =[
        ...
        {title: "¿Cómo te ayudaremos?", body: "Fomentaremos tu aprendizaje autónomo e independiente con herramientas y recursos como simulacros, videos y temas que encontrarás en el área de lectura critica dentro de las pruebas saber 11.", position: "r", img:"/img/Elt (1).png"},
