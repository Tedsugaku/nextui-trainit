            ...
            <div className="text-center  leading-8 sm:leading-10  mb-5 ">
              ...
              <div className="grid place-content-center">
                <a href="/auth/login" className="">
                              <Button className="bg-[url('/img/Fnd.png')] bg-cover text-white shadow-lg w-64 h-20">
                              {/* <Button className="bg-gradient-to-tr from-purple-600 to-blue-400 text-white shadow-lg w-64 h-20"> */}
